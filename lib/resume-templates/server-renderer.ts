...
export const variantStyles: Record<ResumeVariantId, {
    ...
    tailored: {
        ...
        contactLine: 'text-[10px] text-[#cbd5e1]',
        section: 'mb-4',
    ...
    modern: {
        ...
        contactBlock: 'grid grid-cols-2 gap-1 text-xs text-emerald-100',
        contactLine: 'flex items-center gap-1 opacity-80',
        section: 'mb-4 px-6',
    ...
    bold: {
        ...
        contactLine: 'bg-white text-black px-1.5 py-0.5',
        section: 'mb-6',
